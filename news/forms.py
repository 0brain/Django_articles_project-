...
class NewsForm(forms.Form):
    ...
    category = forms.ModelChoiceField(empty_label='Оберіть категорію', label="Категорія", queryset=Category.objects.all(), widget=forms.Select(attrs={'class': 'form-control'}))
